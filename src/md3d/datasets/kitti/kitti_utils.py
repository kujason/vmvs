...
import numpy as np
from md3d.core.voxel_grid_2d import VoxelGrid2D
...
def get_ground_plane(self, sample_name):
    ...
    Returns:
        ground_plane: ground plane coefficients
    """
    ground_plane = obj_utils.get_ground_plane(int(sample_name),
...
def create_sliced_voxel_grid_2d(self, sample_name, source,
    ...
    ground_plane = obj_utils.get_ground_plane(img_idx,
                                              self.dataset.planes_dir)
...
def _check_class(self, obj, classes):
    ...
    """
    return obj.obj_type in classes
